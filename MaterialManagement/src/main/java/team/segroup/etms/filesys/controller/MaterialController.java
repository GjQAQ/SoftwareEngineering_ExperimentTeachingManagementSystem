...
public class MaterialController {
    ...
    @PostMapping
    public ResponseEntity<MaterialMetaBase> uploadMaterial(
        @RequestPart("file") MultipartFile file,
        @RequestParam("description") String description,
        @RequestParam("creatorNid") String creatorNid
    ) {
        MaterialMetaBase materialMeta = new MaterialMetaBase();
        ...
        try {
            MaterialMetaBase meta = materialService.upload(materialMeta, file.getInputStream());
    ...
    @GetMapping("/{id}/meta")
    public ResponseEntity<MaterialMetaBase> findMeta(
        @PathVariable("id") String id
    ) {
        MaterialMetaBase meta = materialService.retrieveMeta(id);
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<MaterialMetaBase> modify(
        @PathVariable("id") String id,
        ...
        MaterialMetaBase newMeta = materialService.modify(meta, inputStream);
